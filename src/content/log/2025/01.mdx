...
_careful this is not my reccomended solution anymore, see the end of the post_
...
So the new template is using [Tempalter](https://silentvoid13.github.io/Templater/) with the following template
