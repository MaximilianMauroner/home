...
export default function LogPreview({ log }: { log: LogType }) {
  const releaseDate = calculateRelativeDate(log.releaseDate);
  return (
    <article className="rounded-lg border border-gray-200 bg-card p-4 shadow-md sm:p-6">
      ...
      <p className="mb-5 font-light text-muted-foreground">{log.description}</p>
