    ...
    <div className="space-y-6 text-gray-900 dark:text-gray-100">
      <div className="flex flex-col gap-5 lg:gap-6">
            ...
            className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-semibold transition ${
              authStatus === "authenticated"
                ...
                : authStatus === "missing"
                  ...
                  : "bg-gray-100 text-gray-600 dark:bg-neutral-800/70 dark:text-gray-300"
            }`}
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <label className="flex-1">
                ...
                <input
                  ...
                  autoComplete="off"
                  className="mt-1 w-full rounded-2xl border border-gray-200 bg-white/95 px-4 py-2 text-sm shadow-inner focus:outline-none focus:ring-4 focus:ring-indigo-200 dark:border-neutral-800 dark:bg-neutral-950/60 dark:text-gray-100 dark:placeholder:text-gray-500 dark:focus:ring-indigo-500/40"
                />
              </label>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-2xl border border-rose-200 px-4 py-2 text-xs font-semibold text-rose-600 transition hover:border-rose-300 hover:bg-rose-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-rose-500/40 dark:text-rose-300 dark:hover:border-rose-400 dark:hover:bg-rose-500/10"
                >
          ...
          <section className="flex flex-col gap-4 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 rounded-full bg-gray-100 p-1 dark:bg-neutral-800/70">
                  <label
            ...
            {runSingle ? (
              <div className="flex flex-col gap-3">
                <label className="flex-1">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-2 text-sm focus:outline-none focus:ring-4 focus:ring-indigo-200 dark:border-neutral-800 dark:bg-neutral-950/40 dark:text-gray-100 dark:focus:ring-indigo-500/40"
                  />
                </label>
                <button
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-wrap items-center gap-2 text-[11px] text-gray-500 dark:text-gray-400">
                  <span className="inline-flex items-center gap-1 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 font-medium text-gray-600 dark:border-neutral-800 dark:bg-neutral-950/40 dark:text-gray-200">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center self-start rounded-full border border-indigo-200 px-4 py-2 text-xs font-semibold text-indigo-600 transition hover:border-indigo-300 hover:bg-indigo-50 dark:border-indigo-500/40 dark:text-indigo-300 dark:hover:border-indigo-400 dark:hover:bg-indigo-500/10"
                >
                  {filtersExpanded ? "Hide filters" : filterButtonLabel}
                </button>

                {filtersExpanded && (
                  <div className="space-y-4 rounded-2xl border border-gray-200 bg-gray-50/70 p-4 dark:border-neutral-800 dark:bg-neutral-950/40">
                          ...
                          <button
                            ...
                            className={`rounded-full border px-3 py-1.5 text-xs capitalize transition ${
                              locations.includes(loc)
                                ? "border-teal-600 bg-teal-500 text-white shadow"
                                : "border-gray-200 bg-white text-gray-700 hover:border-teal-300 dark:border-neutral-800 dark:bg-neutral-900 dark:text-gray-200 dark:hover:border-teal-400"
                            }`}
                          >
                            {loc}
                          </button>
                          ...
                          <button
                            ...
                            className={`rounded-full border px-3 py-1.5 text-xs capitalize transition ${
                              categories.includes(cat)
                                ? "border-pink-600 bg-pink-500 text-white shadow"
                                : "border-gray-200 bg-white text-gray-700 hover:border-pink-300 dark:border-neutral-800 dark:bg-neutral-900 dark:text-gray-200 dark:hover:border-pink-400"
                            }`}
                          >
                            {cat}
                          </button>
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        placeholder="Cursor"
                        className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-2 text-sm focus:outline-none focus:ring-4 focus:ring-pink-200 dark:border-neutral-800 dark:bg-neutral-900 dark:text-gray-100 dark:focus:ring-pink-500/40"
                      />
                    </div>
                  </div>
                )}
        ...
        <div className="flex flex-col gap-5 lg:flex-row">
          <aside className="flex-shrink-0 space-y-4 overflow-hidden rounded-3xl border border-neutral-200 bg-white p-6 shadow-lg lg:sticky lg:top-8 lg:h-[calc(100vh-260px)] lg:w-80 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="flex flex-col items-end gap-1 text-[11px] font-medium">
                <span className="inline-flex w-max items-center gap-1 rounded-full bg-indigo-100 px-2 py-1 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-200">
                ...
                {selectedDocIds.size > 0 && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-100 dark:border-emerald-500/40 dark:bg-emerald-500/10 dark:text-emerald-200 dark:hover:border-emerald-400 dark:hover:bg-emerald-500/20"
                  >
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-indigo-200 bg-white px-3 py-2 text-sm font-semibold text-indigo-600 shadow-sm transition hover:border-indigo-300 hover:bg-indigo-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-indigo-500/40 dark:bg-neutral-900 dark:text-indigo-300 dark:hover:border-indigo-400 dark:hover:bg-indigo-500/10"
            >
              Open selected in Readwise
              {selectedDocIds.size > 0 && (
                <span className="rounded-full bg-indigo-100 px-2 py-0.5 text-xs font-semibold text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-200">
                  {selectedDocIds.size}
                </span>
              )}
            </button>
            ...
            <div className="max-h-[70vh] space-y-3 overflow-y-auto pb-24 pr-1">
              {fetchedDocs.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-indigo-200 bg-indigo-50/60 p-6 text-center text-sm text-indigo-500 dark:border-indigo-500/40 dark:bg-indigo-500/10 dark:text-indigo-200">
                ...
                fetchedDocs.map(({ doc, tags: docTags }) => {
                  ...
                  const cardHighlight = isActive
                    ? "border-indigo-300 bg-indigo-50/80 shadow-lg dark:border-indigo-500/50 dark:bg-indigo-500/10"
                    : isSelected
                      ? "border-emerald-400 bg-emerald-50/80 shadow-lg dark:border-emerald-500/60 dark:bg-emerald-500/10"
                      : hasDiff
                        ...
                        : "border-gray-200 bg-white hover:border-indigo-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-indigo-500/40";
                  ...
                  return (
                    <div
                      ...
                      className={`w-full cursor-pointer rounded-2xl border p-4 text-left transition ${cardHighlight}`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          <span className="text-sm font-semibold text-gray-800 transition hover:text-indigo-600 dark:text-gray-100 dark:hover:text-indigo-300">
                            {doc.title ?? "(no title)"}
                          </span>
                        ...
                        <div className="flex flex-col items-end gap-1 text-[11px] font-semibold">
                          {hasDiff ? (
                            <span className="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-1 text-amber-700 dark:bg-amber-500/10 dark:text-amber-200">
                          ...
                          {extracted.length > 0 && (
                            <span className="inline-flex items-center gap-1 rounded-full bg-indigo-100 px-2 py-1 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-200">
                      ...
                      <div className="mt-3 flex flex-col gap-2">
                            ...
                            <div className="mt-1 flex flex-wrap gap-1.5">
                              {suggestedTags.slice(0, 5).map((t) => (
                                <span
                                  ...
                                  className="rounded-full bg-amber-100 px-2.5 py-1 text-[11px] font-medium text-amber-700 dark:bg-amber-500/10 dark:text-amber-200"
                                >
                                  +{t}
                                </span>
                              ))}
                              {suggestedTags.length > 5 && (
                                <span className="rounded-full bg-amber-100 px-2.5 py-1 text-[11px] font-medium text-amber-700 dark:bg-amber-500/10 dark:text-amber-200">
                            ...
                            <div className="mt-1 flex flex-wrap gap-1.5">
                              {overlapTags.slice(0, 4).map((t) => (
                                <span
                                  ...
                                  className="rounded-full bg-indigo-50 px-2.5 py-1 text-[11px] font-medium text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-200"
                                >
                                  #{t}
                                </span>
                              ))}
                              {overlapTags.length > 4 && (
                                <span className="rounded-full bg-indigo-50 px-2.5 py-1 text-[11px] font-medium text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-200">
                        ...
                        {extracted.length === 0 && existing.length === 0 && (
                          <span className="rounded-full border border-indigo-100 bg-indigo-50 px-2.5 py-1 text-[11px] font-medium text-indigo-700 dark:border-indigo-500/40 dark:bg-indigo-500/10 dark:text-indigo-200">
                            No tags yet
                          </span>
                        )}
                      </div>
          ...
          <section className="flex min-w-0 flex-1 flex-col gap-6 rounded-3xl border border-neutral-200 bg-white p-6 shadow-lg lg:p-8 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="flex flex-col gap-2">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                readOnly
                rows={8}
                className="h-[400px] w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm leading-relaxed text-gray-700 dark:border-neutral-800 dark:bg-neutral-950/40 dark:text-gray-100"
              />
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="space-y-3">
                ...
                <div className="flex min-h-[64px] flex-wrap gap-2 rounded-2xl border border-gray-200 bg-white px-3 py-3 dark:border-neutral-800 dark:bg-neutral-900">
      ...
      {statusMessage && (
        <div className="pointer-events-none fixed inset-x-0 top-24 z-50 flex justify-center px-4">
          <div
            ...
            className={`pointer-events-auto flex w-full max-w-md items-start gap-3 rounded-2xl border px-5 py-4 text-sm shadow-xl backdrop-blur-sm transition lg:text-base ${
          ...
          >
            ...
            <button
              ...
              className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-transparent text-xs font-semibold text-current transition hover:border-current hover:bg-white/20 dark:hover:bg-white/10"
            >
