...
---
import SearchExample from '~/media/log/search-working.png?jsx';
...
The next thing was the search itself. I wanted it to filter results dynamically as you type, but also respect the active tags. 
...
That way, you get an updated list whether you're typing or toggling tags.
...
<SearchExample alt="Tags and search system in action"/>
...
Next, I'm thinking about adding more filter options, maybe by date or category. For now, though, I'm just glad the search and tag system is functional and works without any hitches.